...
},{"_css_loader":"../../../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/css-loader.js"}],"src/data-business.js":[function(require,module,exports) {
"use strict";
...
function getCharacters() {
  return fetch("https://breakingbadapi.com/api/characters").then(function (response) {
    return response.json();
  });
}

function getCharacterInfo(char_id) {
  return fetch("https://breakingbadapi.com/api/characters/" + char_id).then(function (response) {
    return response.json();
  });
}
...
DataBusiness.getCharacters().then(function (characters) {
  ...
  if (nodes.length > 0) document.getElementById("root").innerHTML = "";
...
var handleCharacterClick = function handleCharacterClick(char_id) {
  DataBusiness.getCharacterInfo(char_id).then(function (characterInfo) {
    document.getElementById("character-detail").append(Utils.showCharacter(characterInfo[0]));
  });
};
},{"./styles.css":"src/styles.css","./data-business":"src/data-business.js","./utils":"src/utils.js"}],"../../../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
